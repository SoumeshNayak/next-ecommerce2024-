    ...
    <div className="flex flex-col gap-4">
      ...
      <div className='flex justify-between'>
        ...
        <div className='bg-gray-100 py-2 px-4 rounded-3xl flex items-center justify-between w-32'>
            <button className='cursor-pointer text-xl' onClick={()=>handleQuentity("d")}>-</button>
            {quantity}
            <button className='cursor-pointer text-xl' onClick={()=>handleQuentity("i")}>+</button>
        </div>
        <div className=' text-xs'>Only <span className='text-orange-500'>4 Item</span> left! <br/>{"Don't miss it"}
        </div>
      </div>
